    ...
    return (
        ...
        <section id="our-team" class="bg-gray-100 py-32">
            <div class="container mx-auto px-4" >
                <h2 class="text-3xl font-bold text-center mb-8 text-primary">Meet Our Executives</h2>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6 my-6 text-center">
                        ...
                        <h3 class="text-xl font-semibold mb-2">John Testimony</h3>
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6 my-6 text-center">
                        ...
                        <h3 class="text-xl font-semibold mb-2">Fowe</h3>
                        <p class="text-gray-700">Gen Sec</p>
                    </div>
